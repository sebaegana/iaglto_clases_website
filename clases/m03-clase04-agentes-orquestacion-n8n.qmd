...
### JSON de referencia: `Noticias de Chile (1).json`
...
`C:\Users\sebae\Downloads\Noticias de Chile (1).json`
...
1. `Schedule Daily Tech News Trigger`
...
Este es el flujo importado desde `Noticias de Chile (1).json`.

------------------------------------------------------------------------

## Nodo 1: Schedule Daily Tech News Trigger

Este nodo programa la ejecución diaria del flujo.

### Función

-   activar el flujo a las 8:00
-   convertir el proceso en una rutina automática
...
## Nodo 2: Fetch Google Tech News

Aunque el nombre quedó heredado de una plantilla, este nodo consulta Google News con una búsqueda de noticias financieras.
...
## Nodo 3: Extract Tech News Articles
...
### JSON de referencia: `Noticias de Chile Orquestador v2.json`
...
`C:\Users\sebae\Downloads\Noticias de Chile Orquestador v2.json`
...
Este es el flujo importado desde `Noticias de Chile Orquestador v2.json`.
...
`C:\Users\sebae\Downloads\Noticias de Chile Supervisor Herramientas.json`
